...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <%
            # by BT-mgerecke - ignore first page break
            do_page_break = False
        %>
                  ...
                  <div class="act_as_table list_table" style="margin-top: 10px;">
                      ...
                      <div class="act_as_table list_table">
                          <div class="act_as_row labels" style="font-weight: bold;">
                              ## by BT-mgerecke - date
                        <div class="act_as_cell first_column" style="width: 615px;">${_("Balance")}
                            %if filter_form(data) == 'filter_date':
                                ${formatLang(start_date, date=True) if start_date else u'' }
                            %else:
                                ${start_period.name if start_period else u''}
                        ...
                        <div class="act_as_cell amount" style="width: 75px; padding-right: 1px;">${ formatLang(cumul_balance) | amount }</div>
                            ...
                            %if account.currency_id:
                                ## currency balance
                                <div class="act_as_cell amount sep_left" style="width: 75px;">
                                  ${formatLang(cumul_balance_curr) | amount }</div>
                              %else:
                    ...
                    <div class="act_as_row labels" style="font-weight: bold;padding-top: 15px; padding-bottom: 15px;">
                          ...
                          <div class="act_as_cell amount" style="width: 75px; padding-right: 1px;">
                              %if budget[account.id]:
                                  ${ formatLang(budget[account.id]) | amount }
                              %else:
                                  - - -
                              %endif
                          </div>
